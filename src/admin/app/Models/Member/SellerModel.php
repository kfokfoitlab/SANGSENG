...
class SellerModel extends CommonModel
{
    ...
    { //{{{
        ...
        if($files["seller_information"]["name"] != ""){
            $seller_information_ori =  str_replace('&','＆', $files["seller_information"]["name"]);
        ...
        if($files["sales_file"]["name"] != ""){
            $sales_file_ori =  str_replace('&','＆', $files["sales_file"]["name"]);
        ...
        if($files["workers_file"]["name"] != ""){
            $workers_file_ori = str_replace('&','＆', $files["workers_file"]["name"]);
        ...
        if($files["seller_logo"]["name"] != ""){
            $seller_logo_ori = str_replace('&','＆', $files["seller_logo"]["name"]);
