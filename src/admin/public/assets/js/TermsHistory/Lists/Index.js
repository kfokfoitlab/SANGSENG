$(document).ready(function(){
    ...
    var dt_option = {
        ...
        "columns": [
            ...
            ,{title: "약관", data: "title", visible: true, className: "text-nowrap"}
            ,{title: "적용상태", data: "title", visible: true, className: "text-nowrap"}
            ,{title: "등록일", data: "title", visible: true, className: "text-nowrap"}
            ,{title: "메모", data: "title", visible: true, className: "text-nowrap"}
            ,{title: "상태", data: "status", orderable: false, visible: true, className: "text-center text-nowrap",
