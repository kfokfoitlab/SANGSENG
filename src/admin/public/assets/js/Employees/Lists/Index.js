$(document).ready(function(){
    ...
    var dt_option = {
        ...
        "columns": [
            ...
            ,{title: "회사명", data: "title", visible: true, className: "text-nowrap"}
            ,{title: "근로자명", data: "title", visible: true, className: "text-nowrap"}
            ,{title: "장애유형", data: "title", visible: true, className: "text-nowrap"}
            ,{title: "복지카드", data: "title", visible: true, className: "text-nowrap"}
            ,{title: "근무상태", data: "status", orderable: false, visible: true, className: "text-center text-nowrap",
                "render": function( data, type, row, meta ){
                    switch(data){
                        case "1": return "<span class='badge text-primary'>적용</span>"; break;
                        case "3": return "<span class='badge text-dark'>비적용</span>"; break;
                    }
                }
            }
            ,{title: "상태변경", data: "title", visible: true, className: "text-nowrap"}
